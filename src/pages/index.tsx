...
/* ── HERO ── */
.ea-hero{position:relative;width:100vw;margin-left:calc(-50vw + 50%);min-height:42vh;display:flex;flex-direction:column;justify-content:flex-end;overflow:hidden;background:#04030a;}
...
.ea-hero-inner{position:relative;z-index:6;padding:0 5% 2.5vh;width:100%;max-width:1600px;margin:0 auto;}
/* ── HERO TITLE ── */
...
.ea-eyebrow{display:flex;align-items:center;gap:14px;margin-bottom:.5rem;}
...
.ea-h1-main{display:block;font-family:'Bebas Neue',sans-serif;font-size:clamp(3rem,6vw,5.5rem);letter-spacing:.02em;line-height:.85;background:linear-gradient(110deg,#fff 0%,#ffe8b0 20%,#ffb347 38%,#ff6b35 52%,#e8368e 65%,#a855f7 78%,#60a5fa 90%,#fff 100%);background-size:300% 300%;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;animation:title-shimmer 8s ease infinite;filter:drop-shadow(0 0 60px rgba(255,107,53,.15));}
.ea-h1-brand{display:block;font-family:'Bebas Neue',sans-serif;font-size:clamp(1rem,2vw,1.8rem);letter-spacing:.35em;color:rgba(255,255,255,.22);line-height:1;margin-bottom:-.4rem;}
.ea-hero-desc{font-size:clamp(.78rem,.95vw,.9rem);color:rgba(238,234,224,.42);font-weight:300;line-height:1.6;margin:.75rem 0 0;max-width:560px;}
.ea-hero-areas{display:flex;gap:8px;margin-top:1rem;flex-wrap:wrap;}
...
.ea-stats{display:flex;align-items:stretch;gap:0;margin-top:1rem;flex-wrap:wrap;}
