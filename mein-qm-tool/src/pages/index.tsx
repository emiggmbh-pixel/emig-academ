...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <header style={{ position: 'relative', backgroundImage: `url(${bgImageUrl})`, backgroundSize: '120%', backgroundPosition: '70% 30%', color: 'white', padding: '8rem 1rem', textAlign: 'center' }}>
